...
export default function PublicPage(props){
    ...
    async function fetchPageData() {
        try {
            ...
            // const mergedJson = { ...decodedMenuJson, ...decodedPagejson }
            // setJsonPageData(mergedJson)
            setJsonPageData(decodedPagejson)
    ...
    return (
        <div id='root-dom-container'>
            <Head>
                <title>{public_slug ? `${public_slug} |` : ''} GP Liaison</title>
                <link rel="icon" href="/favicon.png" />
            </Head>
            {/* <div style={{position : 'absolute', top : '0px',width : '100%'}}>
                <Menu inverted borderless style={{backgroundColor : 'transparent', padding : "1em 0.4em", fontWeight : '700', display : 'flex', flexFlow : 'row wrap', justifyContent : 'space-between'}}>
                    <MenuItem>
